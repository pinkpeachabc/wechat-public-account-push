...
export const getAggregatedData = async () => {
  ...
  for (const user of users) {
    ...
    // 获取课表信息
    const courseSchedule = getCourseSchedule(user.courseSchedule || config.courseSchedule)
    ...
    const tianApiWeather = ((await getTianApiWeather(user)) || [])
      .map((it, index) => Object.keys(it)
        .filter(
          (weatherKey) => ['province', 'area', 'weatherimg'].indexOf(weatherKey) === -1,
        )
        .map((key) => ({
 ...
 * @returns
 */
const sendMeessageByWeChatEnterprise = async (
  user,
  templateId,
  wxTemplateData,
) => {
  ...
  const url = 'https://mason-api.azurewebsites.net/api/Wechat/news/'

  const data = {
    corpid: user.corpid,
    corpsecret: user.corpsecret,
    agentid: user.agentid,
    title: 'Doriaの每日提醒',
    thumb_media_id:
      '2Inl1k654mLBmHGeNxQq7NPH0_Cf3oGqWzeWZWiyzTYMoUsUeEs8SPew6dN86X-FQ',
    author: 'Mason',
    content_source_url: 'https://pinkpeachabc.cn/',
    content: modelData.desc,
  }
...
//   //       },
//   //       "birthday_message": {
//   //           "value": "距离 相识纪念日 还有222天 \\n\\n距离 李四 的生日还有250天 \\n\\n距离 宝贝 的生日还有272天 \\n\\n",
//   //           "color": "#92419b"
//   //       },
//   //       "note_en": {
//   //           "value": "A good laugh and a long sleep are the best cures in the doctor's book.",
//   //           "color": "#e6fbef"
//   //       },
//   //       "note_ch": {
//   //           "value": "医生手册写道：开怀大笑，睡个好觉，此乃灵丹妙药 。",
//   //           "color": "#647f60"
//   //       },
//   //       "holidaytts": {
//   //           "value": "你在想什么！今天就是初三啊。",
...
//   //       },
//   //       "earthy_love_words": {
//   //           "value": "只有莲花才能比得上你的圣洁，只有月亮才能比得上你的冰清。",
//   //           "color": "#49a772"
//   //       },
//   //       "moment_copyrighting": {
//   //           "value": "好事总会发生在下个转弯!",
...
//   //           "color": "#390162"
//   //       },
//   //       "comprehensive_horoscope": {
//   //           "value": "今日综合运势: 整体运势不断走高，简直就是开挂的节奏。能够展示出独当一面的姿态，颇有做大事的风范，也能成为很多人想要模仿学习的对象，有点小骄傲。生活方面 好奇心比较旺盛，可以多了解传统文化的知识。",
//   //           "color": "#bf25dd"
//   //       },
//   //       "love_horoscope": {
//   //           "value": "今日爱情运势: 单身的能遵循心意行动，为自己争取幸福。恋爱中的与恋人谈及两人的未来，思 想更加成熟了。",
//   //           "color": "#629ab2"
//   //       },
//   //       "career_horoscope": {
//   //           "value": "今日事业学业: 通过主动了解知识，开阔视野，能够带来一些全新的思路，以及创意想法。",
//   //           "color": "#ab36e0"
//   //       },
//   //       "wealth_horoscope": {
//   //           "value": "今日财富运势: 财运在线，会有来自正财以及偏财的收入，尤其是意外财会给你带来满满的惊喜。",
//   //           "color": "#bbcc92"
//   //       },
//   //       "healthy_horoscope": {
//   //           "value": "今日健康运势: 行动 方面有点冒冒失失，建议尽量不要触碰易碎的东西，也不要用手捡玻璃碎片。",
//   //           "color": "#c2ad3a"
//   //       },
//   //       "love_day": {
//   //           "value": 139,
...
//   //           "color": "#4e3bc2"
//   //       },
//   //       "tian_api_network_hot": {
//   //           "value": "",
//   //           "color": "#adb095"
//   //       }
//   //   }
//   const {to_name,data,province}
// }
...
export const sendMessage = async (templateId, user, params, usePassage) => {
  ...
  if (usePassage === 'wechat-enterprise') {
    console.log('使用企业微信推送')
    return sendMeessageByWeChatEnterprise(user, templateId, wxTemplateData)
  }
...
export const sendMessageReply = async (
  ...
  const maxPushOneMinute = typeof config.MAX_PUSH_ONE_MINUTE === 'number'
